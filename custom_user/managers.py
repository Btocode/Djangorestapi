...
class CustomUserManager(BaseUserManager):
  ...
  def create_superuser(self, email, password, first_name, last_name, phone, types, address, **extra_fields):
    ...
    return self.create_user(email, password, first_name, last_name, phone, types, address, **extra_fields)